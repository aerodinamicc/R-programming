...
```{r princetonPetLoading, cache=TRUE}
...
```{r speiSpiComputation, cache=TRUE}
source('tidyspei.R')
...
```{r wdTibbleComposition, cache=TRUE}
...
```{r dryMonthsAndAnnualRainfall, echo=TRUE, fig.width= 10, cache=TRUE}
#dry months count
...
```{r seasonalFluctuations, echo = TRUE, fig.width= 10, cache=TRUE}
...
```{r corrplotAnnualCwd, echo = TRUE, fig.width= 10, fig.height= 10}
...
```{r absDeviationsFromMean, echo = TRUE, fig.width= 10, fig.height= 15}
...
```{r mcwdAnnualAnomalies, echo = TRUE, fig.width= 10, fig.height= 15}
...
```{r mcwdMonthlyAnomalies, echo = TRUE, fig.width= 10, fig.height= 10}
...
```{r gleichlaufigkeit, echo = TRUE, fig.width= 10, fig.height= 10}
#gleichlaufigkeit -----
source('glk.R')
...
```{r monthlySeverityExtent, echo = TRUE, fig.width= 20, fig.height= 12}
...
```{r summerSeverityExtent2005, echo = TRUE, fig.width= 10, cache=TRUE}
...
```{r summerAetPetSeverityExtent2005, echo = TRUE, fig.width= 4, fig.height=6}
...
```{r annualSeverityExtent, echo = TRUE, fig.width= 10, fig.height= 10}
...
```{r annualSeverityExtent2005, echo = TRUE, fig.width= 10}
#absDeviations (in mm)
...
```{r annualAetPetSeverityExtent2005, echo = TRUE, fig.width= 5, fig.height=6}
severityExtent %>%
  filter(source == "CWD") %>%
  mutate(labelPercentage = ifelse(percentage > 3, paste(percentage, "%"), "")) %>%
  ggplot(aes(x=mcwd, y=percentage, fill=deviationFromMean)) + 
...
```{r spatialCorrelationFun, echo = TRUE}
...
```{r trmmMonthlyAnomaliesCorrelation, echo = TRUE, warning=FALSE, fig.width= 10}
...
```{r sameMetricMonthlyAnomaliesSpatialCorr, echo = TRUE, warning=FALSE, fig.width= 10}
...
```{r trmmAnnualAnomaliesCorrelation, echo = TRUE, warning=FALSE, fig.width= 10}
...
```{r sameMetricAnnualAnomaliesSpatialCorr, echo = TRUE, warning=FALSE, fig.width= 10}
